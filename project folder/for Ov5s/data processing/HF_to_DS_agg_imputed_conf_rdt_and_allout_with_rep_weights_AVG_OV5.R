...
read_dir <- "~/Box/NU-malaria-team/projects/smc_impact/data/outputs/Ov5_HF_cases_smc_coords_imputed_rdts_and_allout_MA_activeHFs.csv"

write_dir <- "~/Box/NU-malaria-team/projects/smc_impact/data/outputs/Ov5_DS_cases_seasonal_smc_good_rows_MA_imputes_w_rep_weights_activeHFs.csv"
